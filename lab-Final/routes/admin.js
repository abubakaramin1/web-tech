...
const { adminOnly } = require("../middlewares/shopMiddleware");
...
// Orders Dashboard (Task 3)
router.get("/orders", adminOnly, async function (req, res) {
  try {
...
// Update Order Status (Task 3)
router.post("/orders/update-status/:id", adminOnly, async function (req, res) {
  try {
