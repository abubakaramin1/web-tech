...
// E-commerce routes (public, no authentication required)
app.use("/", require("./routes/ecommerce"));
app.use("/products", require("./routes/products"));
// Admin routes (separate admin panel) - must come before React admin routes
...
// React admin app routes (fallback for /admin/* if no EJS route matches)
